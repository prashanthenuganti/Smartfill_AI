...
DOCUMENT_FIELD_SPECS: dict[str, dict[str, tuple[str, str]]] = {
    ...
    DocumentType.CERTIFICATE_SSC: {
        ...
        "board":         ("Board of education, exactly as printed on the document",
                          "Verbatim as printed — do not abbreviate or rearrange, e.g. Board of Secondary Education, Telangana State"),
